...
world_map = folium.Map(tiles=None, attr=attr)
...
cluster_data_list = RequestCluster(cluster_list[2])
...
for marker in markers_list:
    popup = folium.Popup(html=marker["html"], max_width=250, max_height=500)
